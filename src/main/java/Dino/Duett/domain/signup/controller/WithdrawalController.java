...
public class WithdrawalController {
    ...
    public JsonBody<Boolean> withdrawal(@Valid @RequestBody WithdrawalReq withdrawalReq) {
        return JsonBody.of(200, "회원탈퇴 성공", withdrawalService.withdrawal(withdrawalReq));
    }
}
